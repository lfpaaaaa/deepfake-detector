#!/usr/bin/env python3
"""
Offline startup script: Launch deepfake detection service using local ResNet50 model only
No internet connection required - completely secure and offline operation
"""
...
def main():
    """Start offline local model service"""
    ...
    print("🔒 Starting OFFLINE Deepfake Detection Service")
    print("=" * 60)
    print("🛡️  SECURE: No internet connection required")
    print("🏠 LOCAL: All processing done on your machine")
    print("=" * 60)
    ...
    try:
        ...
        uvicorn.run(
            ...
            host="0.0.0.0",
            port=8000,
            reload=False,  # Recommended for production
            log_level="info"
        )
